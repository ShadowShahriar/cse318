...
1. **Chapters and Selected Topics**
    ...
    - [**Chapter 11**](#chapter-11) (_half set question_)
        ...
        - Advantages and Disadvantages of Output Methods
...
3. [**Theoretical Questions**](#theoretical-questions)
    ...
    - **Chapter 11**
        ...
        2. [What are some purposes of generating a business report?](#112-what-are-some-purposes-of-generating-a-business-report)
        3. [What are the objectives of Output Design?](#113-what-are-the-objectives-of-output-design)
        4. [Compare the advantages and disadvantages of different output methods.](#114-compare-the-advantages-and-disadvantages-of-different-output-methods)
        5. [Which factors contribute to the decision of choosing an output technology?](#115-which-factors-contribute-to-the-decision-of-choosing-an-output-technology)
        6. [What is output bias and how to mitigate it?](#116-what-is-output-bias-and-how-to-mitigate-it)
...
#### 11.1. Briefly explain the categories of information.

Information can be categorized as:

- <ins><strong>Stragetic Information:</strong></ins> The information needed by the top most management for decision making. The information systems that provide these kinds of information are known as Decision Support Systems **(DSS)**.

    **Example:** Trends in revenues earned by the company.

- <ins><strong>Managerial Information:</strong></ins> Required by the middle management to make short term decisions for the company. Management Information System **(MIS)** caters to such information needs of the company.

    **Example:** Sales analysis for the past quarter or yearly production details.

- <ins><strong>Operational Information:</strong></ins> Required at the operational level for carrying out day-to-day operational acctivities. The information systems that provide these kinds of information are known as Transaction Processing System **(TPS)** or Data Processing System **(DPS)**.

    **Example:** Employee attendance.

---

#### 11.2. What are some purposes of generating a business report?

Reports are the primary means of communication in organization. Some points highlighting the purposes or objectives or important of business report are presented below:

1. Transmitting Information
2. Interpretation and explanation of an event
3. Making decisions
4. Communication with external stakeholders
5. Development of information base
6. Developing labor-management relationship
7. Performance controlling
8. Recommending actions

---

#### 11.3. What are the objectives of Output Design?

Output is processed data or information generated by a computer system and delivered to a user or another system. It transforms raw input into meaningful results like text, graphics, or audio.

> Output is information delivered to the users.

There are mainly two forms of output: **hard copy** (Printed reports) and **soft copy** (PDF files). Output can be delivered via **intranets**, **extranets**, and **the web**.

Main objectives of effective output design:

1. Ensure the use and acceptance of the information system.
2. Serve a specific user or organizational purpose.
3. Become meaningful to the user.
4. Deliver the appropriate quantity of output.
5. Ensure the output is where it is needed.
6. Ensure the output is provided on time.
7. Ensure the most suitable output method.

> Content of output must be considered as interrelated to the output method.

| External Output                                    | Internal Output                   |
| :------------------------------------------------- | :-------------------------------- |
| Going outside the business.                        | Staying within the business.      |
| Example: Utility bills, advertisements, paychecks. | Distribution, design, appearance. |

---

#### 11.4. Compare the advantages and disadvantages of different output methods.

**Video Output**

<p align="center"><img src="output-vid.jpg"/></p>

**Audio Output**

<p align="center"><img src="output-au.jpg"/></p>

---

#### 11.5. Which factors contribute to the decision of choosing an output technology?

Choosing output technology involves analyzing user needs, cost, speed, and environmental factors to ensure effective information delivery.

Key considerations include the audience, required resolution, frequency of access, location, storage requirements, and total cost of ownership (**initial** and **maintenance**). Such as:

- **User and Audience Needs:** Identify who will use the output (e.g., internal staff vs. external clients) and how many people need it.

- **Purpose and Speed:** Define the objective—whether for rapid decision-making (requires high-speed, dynamic output) or archival, legal purposes (requires high-quality, permanent records).

- **Cost:** Evaluate initial purchase price, and ongoing expenses such as toner, paper, and electricity.

- **Environmental Requirements:** Assess space constraints, noise limitations, temperature control, and connectivity for hardware.

- **Distribution/Logistics:** Determine where the output is needed (e.g., remote, centralized, or mobile) and if it requires physical printing or digital display.

- **Flexibility and Quality:** Choose between digital **(screens)** or hard copy **(printers)** based on the needed flexibility and visual quality, such as resolution and color capabilities.

---

#### 11.6. What is output bias and how to mitigate it?

Output bias refers to the unintentional skewing of information presented to users, which leads them to make improper interpretations or decisions. It occurs when the presentation, organization, or filtering of system outputs causes users to overemphasize certain data and overlook others.

**Common Sources of Output Bias:**

- **Sorting Order:** How information is organized influences users. Alphabetical, chronological, or cost-based sorting can disproportionately highlight items listed first, causing users to pay more attention to them.

- **Setting Limits (Exception Reports):** Predefining limits for report content can bias perceptions. If exception reporting limits are set too low, users might receive too many, or irrelevant, alerts, while if they are set too high, important data may be missed.

- **Graphic Selection:** The wrong choice of graphics (e.g., using a bar chart where a scatter plot would be more accurate) can mislead users and conceal data trends.

- **Default Values & Layouts:** How data is presented by default often carries unintentional weight, pushing users toward certain decisions.

**Mitigation Strategies:**

- **User-Centered Prototyping:** Create prototypes of screens and reports with stakeholders and ensure users can interact with them to identify potential distortions early.

- **Ensure Flexibility:** Design systems that allow users to change sorting methods, modify limits, and set their own thresholds to avoid fixed, biased views.

- **User Education:** Train users to recognize potential biases in reports and understand how customization affects the results.

- **Multiple Perspective Auditing:** Encourage users to use multiple outputs (e.g., comparing a summary report with detailed data) to verify the accuracy and neutrality of a particular report.

- **Diverse Data Representation:** Ensure that the data feeding into the system and the teams designing it are diverse, reflecting various perspectives rather than a narrow set of criteria.

- **Contextual Understanding:** Maintain awareness of where bias can enter the system, including the data collection, interpretation of results, and the software development process.

---

#### 11.7. What are the common options for pricing your application?

- **Freemium:** The app is free to download, but users pay to unlock premium features, content, or to remove ads. This is highly effective for user acquisition, allowing customers to try the product before buying.

- **Subscription:** Users pay a recurring fee (monthly or annually) to access the application. This model is favored for creating predictable, recurring revenue and aligning developer incentives with long-term retention.

- **Paid (One-time Purchase):** The user pays a single fee upfront to download and use the app. While straightforward, this model is less popular now due to high market competition.

- **In-App Purchases (IAP):** Often used in games or content apps, this allows users to purchase virtual goods, currency, or extra levels within a free app.

- **Paidmium:** A hybrid model where users pay to download the app, but can still pay for additional features or content within it.

- **Usage-Based/Platform Pricing (SaaS):** Fees are based on consumption (e.g., data used, API requests) or a tiered structure based on usage, which is becoming common for AI-based tools, moving away from traditional per-seat pricing.
